...
public abstract class PackageManager {
    ...
    /**
     * Flag parameter for {@link #installPackage(Uri, IPackageInstallObserver, int)} to
     ...
     * {@link #installPackage(Uri, IPackageInstallObserver, int)} on success.
     * @hide
     */
    ...
    /**
     * Installation return code: this is passed to the {@link IPackageInstallObserver} by
     * {@link #installPackage(Uri, IPackageInstallObserver, int)} if the package is
     * already installed.
     * @hide
     */
    ...
    /**
     * Installation return code: this is passed to the {@link IPackageInstallObserver} by
     * {@link #installPackage(Uri, IPackageInstallObserver, int)} if the package archive
     * file is invalid.
     * @hide
     */
    ...
    /**
     * Installation return code: this is passed to the {@link IPackageInstallObserver} by
     * {@link #installPackage(Uri, IPackageInstallObserver, int)} if the URI passed in
     * is invalid.
     * @hide
     */
    ...
    /**
     * Installation return code: this is passed to the {@link IPackageInstallObserver} by
     * {@link #installPackage(Uri, IPackageInstallObserver, int)} if the package manager
    ...
    /**
     * Installation return code: this is passed to the {@link IPackageInstallObserver} by
     * {@link #installPackage(Uri, IPackageInstallObserver, int)} if a
     ...
     * {@link #installPackage(Uri, IPackageInstallObserver, int)}
     ...
     * {@link #movePackage(Uri, IPackageMoveObserver)} when the
     ...
     * {@link #movePackage(Uri, IPackageMoveObserver)}
    ...
    /**
     * Error code that is passed to the {@link IPackageMoveObserver} by
     * {@link #movePackage(Uri, IPackageMoveObserver)} if the
     ...
     * that {@link Context#startActivity(Intent)} and
     ...
     * those activities that support the {@link Intent#CATEGORY_DEFAULT}.
     *
     ...
     * is complete.
     * {@link IPackageStatsObserver#onGetStatsCompleted(PackageStats, boolean)}
